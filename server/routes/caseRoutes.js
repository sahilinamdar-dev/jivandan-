...
const { createCase, getAllCases, getCaseDetails, updateCaseStatus, getHospitalCases, getMyCase } = require('../controllers/caseController');
const { protect, authorize } = require('../middleware/authMiddleware');

router.get('/', getAllCases);
router.get('/my-case', protect, getMyCase);
